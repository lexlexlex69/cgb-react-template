          ...
          <Row>
            {
              userDetails.is_password_reset === 1 ? (
                <Alert color="danger">Please update your password to proceed.</Alert>
              ) : ''
            }
                ...
                <CardBody className="pt-0">
                  <Row>
                    <Col sm="4">
                      ...
                      <h5 className="font-size-15 text-truncate">Access Level</h5>
                      ...
                      <div className="pt-4">
                        <Row>
                          <Col xs="12">
                            ...
                            <p className="text-muted mb-0">{userDetails.position}</p>
                          </Col>
                        </Row>
                        <div className="mt-4">
                  ...
                  <Form onSubmit={(e) => {
                    ...
                    <div className="row justify-content-end">
                      <Col sm={9}>
                        <div>
                          {
                            userDetails.updatePasswordSuccessMessage && !userDetails.isFetching ? (
                              <UncontrolledAlert
                                color="success"
                                className="alert-dismissible fade show"
                                role="alert"
                              >
                                <i className="mdi mdi-lock-check me-2"></i>{userDetails.updatePasswordSuccessMessage}
                              </UncontrolledAlert>
                            ) : userDetails.updatePasswordError && !userDetails.isFetching ? (
                              <UncontrolledAlert
                                color="danger"
                                className="alert-dismissible fade show"
                                role="alert"
                              >
                                <i className="mdi mdi-lock-open-alert me-2"></i>{userDetails.updatePasswordError}
                              </UncontrolledAlert>
                            ) : null
                          }
                        </div>
