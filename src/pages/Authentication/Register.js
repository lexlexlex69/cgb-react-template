...
import { Row, Col, CardBody, Card, Container, Form, UncontrolledAlert, Spinner } from "reactstrap";
                    ...
                    >
                      ...
                      <div className="mt-4">
                        <Row>
                          ...
                          <Col md="10">
                            {
                              signupStatus.isSignUpSuccess && !signupStatus.isFetching ? (
                                <UncontrolledAlert
                                  color="success"
                                  className="alert-dismissible fade show"
                                  role="alert"
                                >
                                  <i className="mdi mdi-account-check me-2"></i>{signupStatus.SignUpSuccessMessage}
                                </UncontrolledAlert>
                              ) : signupStatus.isSignUpError && !signupStatus.isFetching ? (
                                <UncontrolledAlert
                                  color="danger"
                                  className="alert-dismissible fade show"
                                  role="alert"
                                >
                                  <i className="mdi mdi-account-cancel me-2"></i>{signupStatus.errorMessage}
                                </UncontrolledAlert>
                              ) : null
                            }
                          </Col>
